...
(Mobile) The above notations, as well as True Blind, Flag, Greek, Omega, Random, YesNo`,
  ...
  "b21": new SecretAchievement({
    ...
    unlock: "The secret Time Study is where Time Study 10 would be (i.e. to the left of TS11). Click in that area, and it will appear.",
    type: SecretAchievementType.Both
  }),
  "b22": new SecretAchievement({
    ...
    unlock: "Using Emoji notation, set your Big Crunch autobuyer to a small time value (like 1 second), and wait for a good while. Easier with more progress.",
    type: SecretAchievementType.Both
  }),
...
${enumerate(["design", "christmas", "finnish", "confused", "nicolas", "galactic", "work", "bliss", "blind", "stellar", "aero", "blob"].map(theme => inlineCode(theme)), "disjunction")}.\
Note that secret themes do not exist on the mobile verison of the game.`,
  ...
  "b35": new SecretAchievement({
    ...
    unlock: "Most easily done with the Tickspeed autobuyer set to Singles. Easier with more progress, but will take >1h",
    type: SecretAchievementType.Both
  }),
  "b36": new SecretAchievement({
    ...
    unlock: "Can be done at pretty much any time, but post-Eternity, EC1 will disable TD production and can be easily used for the Achievement.",
    type: SecretAchievementType.Both
  }),
