...
- Post-IC2 (base formula: \`AD1 ^ 0.008\`): Add \`0.001\` to exponent`
  ...
  38: new Achievement({
    ...
    requirement:
      "Buy an Antimatter Galaxy without Dimensional Sacrificing. (Your Antimatter Galaxies are reset on Infinity.)"
  }),
  41: new Achievement({
    id: 41,
  ...
  43: new Achievement({
    ...
    requirement:
      "Get the 8th Antimatter Dimension multiplier to be highest, 7th Antimatter Dimension multiplier second highest, etc.",
...
- Post-IC2 (base formula: \`AD1 ^ 0.008\`): Add \`0.001\` to exponent`
  ...
  71: new Achievement({
    ...
    requirement:
      "Get to infinity with only a single 1st Antimatter Dimension without Dimension Boosts or Antimatter Galaxies, while in the 2nd Antimatter DImension Autobuyer Challenge.",
  ...
  87: new Achievement({
    ...
    unlockStrategy:
      "Buy Time Study 32, disable the Antimatter Galaxy autobuyer, set Dimension Boost autobuyer to 0s, and Big Crunch autobuyer to 0.1-1s depending on how long it takes to buy Dimension Boosts."
  }),
  88: new Achievement({
    id: 88,
...
- Post-IC2 (base formula: \`AD1 ^ 0.008\`): Add \`0.001\` to exponent`
  ...
  107: new Achievement({
    ...
    unlockStrategy:
      "Respec out of Time Study 32 and Infinity in under 5 seconds to avoid multiplying your Infinity gain. Effortless with Time Study 181."
  }),
  108: new Achievement({
    id: 108,
  ...
  111: new Achievement({
    ...
    requirement:
      "Have all your Infinities in your past 10 Infinitites be at least 1.8e308 times higher Infinity Points than the previous one.",
  ...
  124: new Achievement({
    ...
    requirement:
      "Have your Infinity Power per second exceed your Infinity Power for 60 consecutive seconds during a single Infinity.",
    unlockStrategy: `${bold("This will likely happen naturally!")} Remember that Infinity Power is the stuff generated by Infinity Dimensions, which is different from Infinity Points that you get by Crunching.
If you cannot get this naturally, try this strategy anytime after e1000 EP or so: disable ID autobuyers, Eternity, wait for a few seconds, pause *all* autobuyers, then repeatedly buy ID1 as many times as you can until you unlock the Achievement.`
  }),
  125: new Achievement({
    id: 125,
    fullName: "Like feasting on a behind.",
    requirement:
      "Reach 1e90 Infinity Points without having any Infinities or any 1st Antimatter Dimensions in your current Eternity.",
    reward: "Infinity Point multiplier based on time spent this Infinity",
    rewardFormula:
      "thisInfinity = `seconds in infinity * 10 + 1`\n effect = `2 ^ log_10(thisInfinity) * min(thisInfinity ^ 0.11, 500)`",
    unlockStrategy: `Only possible after you buy TS181. Using idle, disable AD/ID autobuyers and eternity, enter Challenge 12, and buy a 4th Antimatter Dimension. Instant on mobile versions of the game; up to 60 minutes on web/Steam without the IPx Dilation upgrade.`
  }),
  126: new Achievement({
    id: 126,
    ...
    unlockStrategy:
      "Reach at least 180 maximum Replicanti Galaxies in an Eternity (using active path will help). Then, disable your Antimatter Galaxy autobuyer, Infinity, and buy your Replicanti Galaxies."
  }),
  127: new Achievement({
    id: 127,
  ...
  131: new Achievement({
    ...
    reward:
      "You gain 2x more Infinities and after Eternity, you permanently keep 5% of your Infinities as Banked Infinities (stacks with TS191 to a total of 10%)",
  ...
  133: new Achievement({
    ...
    requirement:
      "Reach 1e200,000 Infinity Points without buying any Infinity Dimensions or the ×2 Infinity Point multiplier",
    reward: "You start Eternities with all Infinity Challenges unlocked and completed.",
    rewardFormula:
      "Due to Eternity Mileston 7, ICs are automatically beaten when they are unlocked. This achievement reward grants Infinity Challenges without having to reach a certain amount of Antimatter to unlock them."
  }),
  134: new Achievement({
    id: 134,
  ...
  138: new Achievement({
    ...
    reward:
      "Removes the downsides from Time Study 131 (disabling Replicanti Galaxy autobuyer) and Time Study 133 (10x slower Replicanti) in the Active and Idle Time Study paths."
  }),
  141: new Achievement({
    id: 141,
  ...
  143: new Achievement({
    ...
    requirement:
      "Have all your Eternities in your past 10 Eternities be for at least 1.8e308 times higher Eternity Points than the previous one.",
...
- 3: Begin using this TS tree: ${inlineCode("11,21,22,32,42,51,61,time,111,idle,151,161,162,171,181,31,41,33,62,72,71,81,82,91,92,102,101,191,192,193,211,212,213,214,201|0")}.
...
- 8-10: Use a standard EP grinding TS tree & buy RGs manually until you reach the goal.
  ...
  163: new Achievement({
    ...
    requirement:
      "Complete all the Eternity Challenges 5 times with less than 1 second (game time) in your current Reality."
  }),
  164: new Achievement({
    id: 164,
  ...
  172: new Achievement({
    ...
    requirement:
      "Reality for 1.8e308 Reality Machines without having any Charged Infinity Upgrades, having any equipped Glyphs, or buying any Triad Studies."
  }),
  173: new Achievement({
    id: 173,
