      ...
      subcommand
        ...
        .addStringOption(option =>
          option
            ...
            .setChoices(
              Object.keys(alchemyInfo).map(choice => ({
                name: choice,
                value: choice,
      ...
      subcommand
        ...
        .addStringOption(option =>
          option
            ...
            .setChoices(
              Object.entries(alchemyResources).map(resource => ({
