import { bold, SlashCommandBuilder, spoiler } from "discord.js";
...
export default new BasicTextCommand({
  data: new SlashCommandBuilder()
    ...
    .setDescription("Sends an abbreviation guide, based on the one from the mobile How to Play"),
  text: `
----- Pre-Infinity -----
${bold("AM")}: Antimatter
...
----- Infinity -----
${spoiler(`${bold("NC X")} or simply ${bold("C X")}: Normal Challenge X`)}
